...
Population access to basic water services

Distribution of rural vs. urban water sources

Type and frequency of required improvements

Provincial disparities in cost and accessibility

Budget allocation and projected impact once improvements are completed
...
✔️ 2. Improvements planned could raise basic access by 64%

Data modelling shows a significant increase in water access once the proposed upgrades are completed.

✔️ 3. Major upgrades are needed for public/shared taps

Shared taps serve the majority of people, especially in rural areas, and require the highest number of interventions.

✔️ 4. Sokoto and Kilimani account for the highest total improvement costs

Both provinces consume over £40M each, driven by extensive drilling and installation needs.

✔️ 5. Drilling wells and installing multiple taps are the most expensive improvements
...
Data Modelling (relationships, fact/dimension tables)

DAX Measures for KPIs and impact modelling
